...
## BWA Revisted (OnDemand Amarel Desktop)
...
# Align the reads and include a `read group' header, e.g.: 
bwa mem \
 -R "@RG\tID:group1\tSM:sam1\tPL:illumina\tLB:lib1\tPU:unit1" \
 genomefile.fa myfastqfile.fq > bwaalign.sam
...
samtools mpileup -f genomefile.fa \ 
  myalignments.sorted.bam > myalignments.pileup
```
...
gatk CreateSequenceDictionary -R chrX_5MB.fa
# make .vcf file!
